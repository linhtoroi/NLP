...
def load_processed_data(args):
    ...
    if args.process_sql_in_execution_order:
        ...
        if not os.path.exists(pred_restored_cache_path):
            ...
            # cache_path = '/home/linhhoang/TabularSemanticParsing/data/spider/dev.eo.pred.restored.pkl'
    ...
    # in_pkl = '/home/linhhoang/TabularSemanticParsing/data/spider/spider.bridge.question-split.ppl-0.85.2.dn.eo.bert.pkl'
...
def load_vocabs_seq2seq_ptr(args):
    ...
    program_vocab = sql_reserved_tokens if args.pretrained_bert else sql_reserved_tokens_revtok
