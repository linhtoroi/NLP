...
def get_tokenizer_tag(args):
    if args.pretrained_bert.startswith('bert-') and args.pretrained_bert.endswith('-uncased'):
        return 'bert.'
    else:
...
def get_wandb_group(args):
    ...
    return '{}{}{}{}{}{}{}-norm-digit-{}-{}-{}-{}-{}-{}-{}-{}'.format(
        pl_tag, le_tag, me_tag, ge_tag, ts_tag, rfo_tag, args.pretrained_bert, args.encoder_hidden_dim,
...
def get_model_subdir(args, with_time_stamp=True):
    ...
    initialization_tag = '{}.'.format(args.pretrained_bert)
    ...
    if args.pretrained_bert and not args.fix_pretrained_bert_parameters:
